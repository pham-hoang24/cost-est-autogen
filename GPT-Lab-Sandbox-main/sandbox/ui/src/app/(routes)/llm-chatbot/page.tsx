...
export default function LLMChatbotPage() {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      type: 'bot',
      content: "Hello! I'm your lightweight AI assistant integrated into the SW4E Sandbox. I can help you with various tasks like chatting, coding, analysis, and more. What would you like to explore today?",
      timestamp: new Date()
    }
  ]);
  ...
  const getFallbackResponse = (message: string): string => {
    ...
    if (lowerMsg.includes('hello') || lowerMsg.includes('hi')) {
      ...
      return "Perfect! This is exactly what you need for your demo tomorrow. The LLM chatbot is now fully integrated into the SW4E Sandbox and ready to show to your project team! 🎯";
    } else if (lowerMsg.includes('sandbox')) {
      return "Yes! I'm now fully integrated into the SW4E Sandbox application. You can access me through the main navigation, and I'm part of the complete AI research environment.";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Integrated into SW4E Sandbox - Ready for Demo!
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="space-y-1 text-gray-600">
                  <li>• Fully integrated into SW4E Sandbox</li>
