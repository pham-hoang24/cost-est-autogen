export function Badge({ children, variant = 'muted', className }: { children: React.ReactNode; variant?: 'muted' | 'accent' | 'outline' | 'secondary' | 'green' | 'yellow' | 'red' | 'gray'; className?: string }) {
  const getStyles = () => {
    switch (variant) {
