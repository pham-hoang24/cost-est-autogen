...
def build_cocomo_agent(llm_config):
    return ConversableAgent(
        ...
        system_message=(
            ...
            "4. LOOP PREVENTION: Check `context.asked_fields['cocomo2']`.\n"
            ...
            "   - Call `report_missing_inputs_tool(project_id, \"cocomo2\", [list of missing inputs])\n"
            "   - Each missing input should be: {\"field\": \"field_name\", \"prompt\": \"user-friendly prompt\", \"priority\": \"critical\"}\n"
