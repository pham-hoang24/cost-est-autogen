...
class DummyModelClient(ChatCompletionClient, Component[DummyModelConfig]):
    """
    Deterministic model client that mirrors the important bits of tool output back to the user.

    This lets us exercise the workflow end-to-end in environments without LLM access.
    """
    ...
    def _extract_from_function_result(self, message: FunctionExecutionResultMessage) -> Optional[str]:
        # FunctionExecutionResultMessage.content is a list of FunctionExecutionResult entries.
